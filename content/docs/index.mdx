...
**Artisan Suite of products**: Artisan technical stack, made of an efficient RPC endpoint, a private network, a bid system, a operation bundle sender and a blockbuilder. 
