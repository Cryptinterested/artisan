...
To utilize Artisan Refund RPC, it's essential to integrate our RPC endpoint to your wallet. 
This can be done effortlessly by following the provided instructions below, or directly clicking on the Green button `Add Artisan RPC refund` on top of the home page.
 Please note that once Artisan RPC 
